...
parser.add_argument('--equal', type=bool, default=False, help='use equal')
parser.add_argument('--net', type=str, default='CNN', help='network')
...
def create_model():
    if args.net == 'CNN':
        model = CNN(num_classes=args.num_class)
        model = model.cuda()
    else:
...
for epoch in range(args.num_epochs+1):   
    ...
    if epoch<warm_up:       
        ...
        if args.equal:
            ...
            pred1 = (prob1_tmp > args.p_threshold) 
